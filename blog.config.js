...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '欢迎来到中国会所黄页',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '全国性息大队', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '中国会所黄页', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.91home.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '性息,修车，茶馆', // 网站关键词 英文逗号隔开
